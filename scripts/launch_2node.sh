...
# Primary controlled comparison uses the same world16 FSDP2 topology as the
# DMD-System MiniMax matched baseline. Set CONFIG=..._2x8.yaml explicitly for
# the HSDP systems ablation.
CONFIG=${CONFIG:-"${REPO_ROOT}/configs/minimax_h3_t2av_dmd_a100_world16.yaml"}
NNODES=${NNODES:-2}
